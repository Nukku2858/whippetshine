...
import WhippetLogo from "@/components/WhippetLogo";

const FooterSection = () => {
  return (
    <footer className="relative py-16 px-4 md:px-6 border-t border-border overflow-hidden">
      <WhippetLogo className="absolute left-[-3%] top-1/2 -translate-y-1/2 w-48 md:w-72 text-primary opacity-[0.08] pointer-events-none select-none" />
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            <WhippetLogo className="h-9 w-12 text-primary" />
